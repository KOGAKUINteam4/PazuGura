...
{
    public static bool CheckInterSection(GameObject Line1A, GameObject Line1B, GameObject Line2A, GameObject Line2B)
    {
        Vector3 Line1 = Line1B.transform.position - Line1A.transform.position;
        Vector3 Line2 = Line2B.transform.position - Line2A.transform.position;

        Vector3 intersectionPoint;

        bool intersect = false;

        bool intersect1 = Math3d.LineLineIntersection(out intersectionPoint, Line1A.transform.position, Line1, Line2A.transform.position, Line2);
        bool intersect2 = Math3d.LineLineIntersection(out intersectionPoint, Line2A.transform.position, Line2, Line1A.transform.position, Line1);
    ...
    public static bool CheckInterSection(Vector3 Line1A, Vector3 Line1B, Vector3 Line2A, Vector3 Line2B)
    {
        Vector3 Line1 = Line1B - Line1A;
        Vector3 Line2 = Line2B - Line2A;

        Vector3 intersectionPoint;

        bool intersect = false;

        bool intersect1 = Math3d.LineLineIntersection(out intersectionPoint, Line1A, Line1, Line2A, Line2);
        bool intersect2 = Math3d.LineLineIntersection(out intersectionPoint, Line2A, Line2, Line1A, Line1);
